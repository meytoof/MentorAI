      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel className="mx-auto max-w-sm rounded-xl border border-white/10 bg-neutral-900 p-6 shadow-xl">
          ...
          <button
            ...
            className="mt-4 flex w-full items-center justify-center gap-3 rounded-md border border-neutral-700 bg-white px-3 py-2.5 text-sm font-medium text-neutral-800 transition-colors hover:bg-neutral-100"
          >
            <GoogleIcon />
